"""
Sehwag  is learning Graph Theory and he is given a task to solve on Graphs.The task is given below:

Given a directed graph with V vertices, E edges and a source vertex S and all edges in the graph.

The task is to find the all neighbouring nodes to the given source vertex.If no node exist print -1
